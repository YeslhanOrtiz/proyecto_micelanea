                            ...
                            case 7:
                                ...
                                if (ano / 4 == 0)
                                {
                                    if (ano / 100 == 0)
                                    {
                                        if (ano / 400 == 0)
                                        {
                                            Console.WriteLine("El año " + ano + " si es bisiesto");
                                        }
                                        else
                                        {
                    ...
                    case 3:
                        ...
                        switch (opcion_3)
                        {
                            ...
                            case 5:
                                ...
                                {
                                    Console.WriteLine("El cuadrado de " + num1 + " = " + Math.Pow(num1, 2));
                                    resultado = resultado + (int)Math.Pow(num1, 2);
                                }
                                Console.WriteLine("-------------------------------");
                                Console.WriteLine("La suma de los cien primeros cuadrados es: " + resultado);
                                break;
                            ...
                            case 7:
                                ...
                                do
                                {
                                    ...
                                    num1 = Convert.ToInt32(Console.ReadLine());
                                    res_suma = res_suma + num1;
                                } while (num1 != 0);
                                Console.WriteLine("La suma de todos los números es: " + res_suma);
                                break;
